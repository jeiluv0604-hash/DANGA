...
class TestAnalystAPI:
    ...
    def test_generate_and_get_daily_brief(self):
        ...
        res = client.post("/api/v1/analyst/daily/2026-06-12?regenerate=true")
    ...
    def test_ai_014_human_approve_workflow(self):
        ...
        res_gen = client.post("/api/v1/analyst/daily/2026-06-12?regenerate=true")
    ...
    def test_ai_015_human_reject_workflow(self):
        ...
        res_gen = client.post("/api/v1/analyst/daily/2026-07-08?regenerate=true")
        brief_id = res_gen.json()["brief_id"]
